...
<p>Tarjeta actual <?php echo $current_card; ?></p>
    <table border="1">
    <tr>
    <th>Ultima vez activado Europa</th>
    <td><?php echo $lastactive_eur;?></td> 
    </tr>
    <tr>
    <th>Tarjeta Europea</th>
    <td><?php echo $card_europe;?></td> 
    </tr>
    <tr>
...
<table border="1">
<tr>
<th>Ultima vez activado Internacional</th>
<td><?php echo $lastactive_int;?></td> 
</tr>
<tr>
<th>Tarjeta International</th>
